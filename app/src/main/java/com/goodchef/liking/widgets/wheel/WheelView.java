package com.goodchef.liking.widgets.wheel;
...
import com.goodchef.liking.widgets.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int wheelLine = R.color.lesson_details_gray_back;
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        initData(context);
        Log.e("WheelView", "WheelView create");
    }
    ...
    public void setWheelLine(int wheelLine) {
        this.wheelLine = wheelLine;
    }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(wheelLine));
        // 设置线宽
    ...
    private boolean addViewItem(int index, boolean first) {
        ...
        if (view != null) {
            int padding = getContext().getResources().getDimensionPixelSize(R.dimen.sixteen);
