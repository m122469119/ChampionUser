...
public class MyCustomCircleView extends View {
    ...
    public MyCustomCircleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色， */
        paint.setColor(ResourceUtils.getColor(R.color.ccccccc));
        /** 结合处为圆弧*/
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(ResourceUtils.getColor(R.color.white));
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        Typeface font = TypefaseUtil.getImpactTypeface(getContext());
        vTextPaint.setTypeface(font);
        vTextPaint.setColor(ResourceUtils.getColor(R.color.white));
