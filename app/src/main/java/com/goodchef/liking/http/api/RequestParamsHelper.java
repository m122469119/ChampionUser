...
public class RequestParamsHelper {
    ...
    //1.3.0 appkey :Yc7T1ao8YnoH6ftAX2E4
    public static String REQUEST_APP_KEY = EnvironmentUtils.Config.isDebugMode() ? "testCcmsIam500QiangA" : "Yc7T1ao8YnoH6ftAX2E4"; //app签名key
