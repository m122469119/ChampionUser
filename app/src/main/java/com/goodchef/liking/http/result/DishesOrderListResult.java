 ...
 * Time:16/6/28 下午3:11
 */
public class DishesOrderListResult extends BaseResult {
    @SerializedName("data")
    ...
    public static class DishesOrderData extends BaseData {
        @SerializedName("list")
        ...
        public static class DishesOrder extends BaseData {
