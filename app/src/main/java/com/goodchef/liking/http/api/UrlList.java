...
public class UrlList {
    ...
    public static final String UPLOAD_USER_IMAGE = EnvironmentUtils.Config.isTestMode() ? "http://testimg.likingfit.com/upload/image" : "http://img.likingfit.com/upload/image";
    /**上报手机信息*/
    ...
    /** 个人界面获取优惠券*/
    public static final String GET_MY_COUPON = getVersionHostUrl() + "/coupon/get-my-coupon";
    /** 获取优惠券详情*/
