...
public class LikingCommonInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        LiKingApi.sRequestTimestamp = DateUtils.currentDataSeconds() + LiKingApi.sTimestampOffset;
        LogUtils.i(TAG, "request timestamp: " + DateUtils.formatDate(LiKingApi.sRequestTimestamp * 1000L, 3, "-"));
        ...
        HttpUrl.Builder httpUrlBuilder = oldRequest.url().newBuilder()
                ...
                .addQueryParameter("signature", RequestParamsHelper.getSignature(String.valueOf(LiKingApi.sRequestTimestamp), requestId))
                .addQueryParameter("timestamp", String.valueOf(LiKingApi.sRequestTimestamp))
