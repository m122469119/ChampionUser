...
public class CouponPresenter extends BasePresenter<CouponView> {
    ...
    public void getCoupons(String courseId, String goodInfo, Integer cardId, Integer type, int page, BasePagerLoaderViewFragment fragment) {
        LiKingApi.getCoupons(courseId, goodInfo, cardId, type, Preference.getToken(), page, new BasePagerLoaderViewFragment.PagerRequestCallback<CouponsResult>(fragment) {
            @Override
