...
public class SelfHelpGroupActivity extends AppBarActivity implements View.OnClickListener, SelfHelpCourseContract.SelfHelpGroupCoursesView {
    ...
    @BindView(R.id.self_help_group_courses_time_RecyclerView)
    RecyclerView mCoursesTimeRecyclerView;
    @BindView(R.id.self_help_user_time)
    TextView mUserTimeTextView;//使用时段
    @BindView(R.id.self_help_gym_RecyclerView)
    RecyclerView mGymRecyclerView;
    @BindView(R.id.self_help_gym_image)
    HImageView mSelfGymHImageView;
    @BindView(R.id.group_courses_train_object)
    TextView mCoursesTrainTextView;//课程训练名称
    @BindView(R.id.group_courses_duration)
    TextView mCoursesDurationTextView;//课程训练时长
    @BindView(R.id.group_courses_strong)
    TextView mGroupCoursesStrongTextView;//课程强度
    @BindView(R.id.self_help_courses_introduce)
    TextView mCoursesIntroduceTextView;//课程介绍
    @BindView(R.id.accommodate_user_number)
    TextView mAccommodateNumberTextView;//最多容纳人数
    @BindView(R.id.layout_select_group_courses)
    LinearLayout mSelectCoursesLayout;//选择课程布局
    @BindView(R.id.layout_self_group_courses_none)
    LinearLayout mNoneCoursesLayout;//没有选择课程布局
    @BindView(R.id.self_help_stateView)
    ...
    ImageView noDataImageView;//当前时间预留教练排团体课
