 ...
 * Time:16/9/18 下午3:30
 */
public class ChangeGymFragment extends BaseMVPFragment<GymListContract.Presenter> implements GymListContract.View, android.view.View.OnClickListener {
    ...
    private android.view.View mNoCardHeadView;
    ...
    public android.view.View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        android.view.View view = inflater.inflate(R.layout.fragment_change_gym, container, false);
        ...
        mStateView.setOnRetryRequestListener(new StateView.OnRetryRequestListener() {
            ...
            public void onRetryRequested() {
                if (!EnvironmentUtils.Network.isNetWorkAvailable()) {
                    ...
                    if (!StringUtils.isEmpty(mPresenter.getCityId())) {
                        sendGymRequest();
                    }
                }
            }
    ...
    private void getInitData() {
        ...
        if (bundle != null) {
            mPresenter.setCityId(bundle.getString(LikingHomeActivity.KEY_SELECT_CITY_ID));
            mPresenter.setGymId(bundle.getString(LikingLessonFragment.KEY_GYM_ID));
            mPresenter.setTabIndex(bundle.getInt(LikingHomeActivity.KEY_TAB_INDEX, 0));
            mPresenter.setIslocation(bundle.getBoolean(LikingHomeActivity.KEY_WHETHER_LOCATION));
        }
    }
    ...
    public void updateCheckGymView(CheckGymListResult.CheckGymData checkGymData) {
        if (checkGymData != null) {
            ...
            if (allGymList != null && allGymList.size() > 0) {
                ...
                mPresenter.setDefaultCheck(allGymList);
            ...
            if (mMyGym != null && !StringUtils.isEmpty(mMyGym.getGymId()) && !StringUtils.isEmpty(mMyGym.getGymName())) {
                ...
                mMyTextView.setVisibility(android.view.View.VISIBLE);
                ...
                mMyTextView.setVisibility(android.view.View.GONE);
            }
    ...
    private void setNoDataView() {
        android.view.View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_chenge_no_data, null, false);
        ...
        CheckGymListResult.CheckGymData.MyGymData mMyGym = mPresenter.getMyGym();
        if (mMyGym != null && !StringUtils.isEmpty(mMyGym.getGymId()) && !StringUtils.isEmpty(mMyGym.getGymName())) {
            imageView.setVisibility(android.view.View.GONE);
            myGymTextView.setVisibility(android.view.View.VISIBLE);
            ...
            myGymTextView.setVisibility(android.view.View.GONE);
        }
        myGymTextView.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
        ...
        mChangeGymAdapter.setOnRecycleViewItemClickListener(new OnRecycleViewItemClickListener() {
            ...
            public void onItemClick(android.view.View view, int position) {
                ...
                if (textView != null) {
                    ...
                    if (checkGym != null) {
                        for (CheckGymListResult.CheckGymData.CheckGym gym : mPresenter.getAllGymList()) {
    ...
    private void jumpLikingHomeActivity(String gymId) {
        ...
        postEvent(new ChangGymMessage(mPresenter.getTabIndex()));
        Intent intent = new Intent(getActivity(), LikingHomeActivity.class);
        intent.putExtra(LikingHomeActivity.KEY_INTENT_TAB, mPresenter.getTabIndex());
    ...
    public void onEvent(RefreshChangeCityMessage message) {
        ...
        mPresenter.setCityId(message.getCityId());
        mPresenter.setLongitude(message.getLongitude());
        mPresenter.setLatitude(message.getLatitude());
        sendGymRequest();
    }
    ...
    public void setPresenter() {
        mPresenter = new GymListContract.Presenter();
    }
}
